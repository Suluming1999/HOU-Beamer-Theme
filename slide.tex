...
\author{\begin{otherlanguage*}{vietnamese}Nguyễn Mơ\end{otherlanguage*}}
\title{HOU Beamer Theme}

%\subtitle{毕业论文开题报告}
\subtitle{\begin{otherlanguage*}{vietnamese}Báo cáo đề xuất luận án\end{otherlanguage*}}

%\institute{中国人民大学国际关系学院}
\institute{\begin{otherlanguage*}{vietnamese}Trường Đại học Mở Hà Nội \end{otherlanguage*} }

%\date{2020年5月9日}
\date{\begin{otherlanguage*}{vietnamese}Ngày 22 tháng 8 năm 2024\end{otherlanguage*}}
...
\begin{frame}{用Beamer很高大上？}
    \begin{itemize}[<+-| alert@+>] % 当然，除了alert，手动在里面插 \pause 也行
    	\item 	Hà Nội là thủ đô, đồng thời là thành phố đứng đầu Việt Nam về diện tích tự nhiên và đứng thứ hai về diện tích đô thị sau thành phố Hồ Chí Minh, nó cũng đứng thứ hai về dân số với 6.913.161 người.
...
\begin{frame}
    \begin{itemize}
        ...
        \item 但是最初的 \href{http://far.tooold.cn/post/latex/beamertsinghua}{\color{purple}{link}} \cite{origin}已经失效了
         \item 本模板在Trinkle23897的THU-Beamer-Theme基础上修改而成，感谢苏鹿鸣与\begin{otherlanguage*}{vietnamese}Nguyễn Mơ\end{otherlanguage*}同学！\href{https://github.com/Trinkle23897/THU-Beamer-Theme}{\color{red}{戳我}}
    \end{itemize}
\end{frame}
